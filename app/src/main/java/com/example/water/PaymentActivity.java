...
public class PaymentActivity extends AppCompatActivity {
    ...
    EditText editTextNumOfCans, editTextAmount, editTextName, editTextUpi, editTextNote;
    Button buttonSend;
    String TAG ="main";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextUpi = (EditText) findViewById(R.id.editTextUpi);
        ...
        buttonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editTextUpi.setText("franklinjosephgrace@oksbi");
                ...
                if(upi.isEmpty()){
                    editTextUpi.setError("UPI-ID is required!");
                    editTextUpi.requestFocus();
                    return;
                }

                if(note.isEmpty()){
                    editTextNote.setError("Notes is required!");
                    editTextNote.requestFocus();
                    return;
                }

                payUsingUpi(editTextName.getText().toString(), editTextUpi.getText().toString(),
                        editTextNote.getText().toString(), editTextAmount.getText().toString());
